package com.nash.android.backgroundservice
...
import com.nash.android.util.toNashDate
...
class CustomerDownloadService : IntentService(CustomerDownloadService::class.simpleName) {
    ...
    private val notificationChannelId = "com.nash.android.notification.channel"
