...
class CustomerListAdapter(val data: MutableList<CustomerDataModel> = mutableListOf(), private val onItemClickListener: (CustomerDataModel) -> Unit) : RecyclerView.Adapter<CustomerListAdapter.CustomerListViewHolder>() {
