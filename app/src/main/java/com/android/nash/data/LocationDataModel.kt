...
@Parcel
data class LocationDataModel(var locationName: String = "", var locationAddress: String = "", var phoneNumber: String = "", var uuid: String = "", @get:Exclude var selectedServices: MutableList<ServiceGroupDataModel> = mutableListOf(), var user: UserDataModel = UserDataModel(), @get:Exclude var therapists: MutableList<TherapistDataModel> = mutableListOf(), var totalServices: Int = 0)