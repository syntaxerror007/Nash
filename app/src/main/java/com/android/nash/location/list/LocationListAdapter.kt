...
class LocationListAdapter(private val items: List<LocationDataModel>, private val listener: (LocationDataModel) -> Unit) : RecyclerView.Adapter<LocationListAdapter.LocationViewHolder>() {
    ...
    override fun onBindViewHolder(holder: LocationViewHolder, position: Int) = holder.bind(items[position], listener)
